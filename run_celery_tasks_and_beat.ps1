...
start-process celery -ArgumentList "worker -A libs.CeleryTasks.tasks -c 2 -l info -Q Eyelashes_inquiry,celery --purge -n Eyelashes[inquiry]@localhost"
...
start-process celery -ArgumentList "worker -A libs.CeleryTasks.tasks -c 2 -l info -Q Eyelashes_inquiry_Emily,celery --purge -n Eyelashes[inquiry]:Emily@localhost"
...
start-process celery -ArgumentList "worker -A libs.CeleryTasks.tasks -c 2 -l info -Q Eyelashes_inquiry_Ada,celery --purge -n Eyelashes[inquiry]:Ada@localhost"
