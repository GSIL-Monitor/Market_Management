...
minutes_0_45_5_1 = ','.join([str(x) for x in range(1, 45, 5)])
...
app.conf.beat_schedule = {
    ...
    'Eyelashes_p4p_check_00': {                                          # 直通车App
        ...
        'schedule': crontab(day_of_week='0-4', minute=minutes_0_45_5_1, hour='14'),
        'kwargs': {'group': '直通车App'},
        'options': {'queue': 'Eyelashes_p4p_1'}
    },
    'Eyelashes_p4p_check_01': {                                          # 直通车App
        'task': 'tasks.p4p_check',
        'schedule': crontab(day_of_week='0-4', minute=minutes_0_60_5_1, hour='0-13,23'),
        'kwargs': {'group': '直通车App'},
        'options': {'queue': 'Eyelashes_p4p_1'}
    },
    'Eyelashes_p4p_turn_all_off_02': {                                   # 直通车App
        'task': 'tasks.p4p_turn_all_off',
        'schedule': crontab(day_of_week='0-4', minute='49', hour='14'),
        'kwargs': {'group': '直通车App'},
        'options': {'queue': 'Eyelashes_p4p_1'}
    },
    ...
    'Eyelashes_p4p_turn_all_off_17': {                                   # 直通车高消费词
        'task': 'tasks.p4p_turn_all_off',
        'schedule': crontab(day_of_week='0-4', minute='4', hour='6'),
        'kwargs': {'group': '直通车高消费词'},
        'options': {'queue': 'Eyelashes_p4p_2'}
    },
    ...
    'Eyelashes_mail_to_visitors': {
        'task': 'tasks.mail_to_visitors',
