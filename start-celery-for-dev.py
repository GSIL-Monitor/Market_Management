...
celery_cmdline = 'celery worker -A tasks -l INFO --concurrency=1'.split(" ")
...
class MyHandler(PatternMatchingEventHandler):
    ...
    def on_any_event(self, event):
        ...
        for proc in psutil.process_iter():
            ...
            is_celery_worker = celery_cmdline[0] == proc_cmdline[0] \
                               and celery_cmdline[1] == proc_cmdline[1]

            if 'celery' in proc_cmdline[0].lower():
                print('=========>>>>>>>>>>', is_celery_worker, proc_cmdline)
